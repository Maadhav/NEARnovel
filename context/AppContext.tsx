...
interface NEONNovelContract extends Contract {
  getUser: Function;
  addUser: Function;
  addStory: Function;
  getStories: Function;
...
export const AppContextProvider = ({ children }: Props) => {
  ...
  const initContract = async () => {
    ...
    const walletConnection = new WalletConnection(near, "NEONnovel");
  ...
  const fetchCurrentUser = async () => {
    const contract = nearContract as NEONNovelContract;
